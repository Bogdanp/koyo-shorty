...
(current-locale-specifier 'shorty)
(load-locales! locales-path)


;; config values ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

(current-option-name-prefix "SHORTY")
...
(define-values (_ default-db-host default-db-port default-db-name default-db-username default-db-password)
  (parse-database-url (or (getenv "DATABASE_URL") "postgres://shorty:shorty@127.0.0.1:5432/shorty")))
...
(define-option test-db-name #:default "shorty_tests")
(define-option test-db-username #:default "shorty")
(define-option test-db-password #:default "shorty")
...
(define-option session-secret-key-path #:default "/tmp/shorty-secret-key")
...
(define-option product-name #:default "shorty")
(define-option company-name #:default "shorty")
(define-option company-address #:default "")
(define-option support-name #:default "Bot Botterson")
(define-option support-email #:default "support@shorty.com")
